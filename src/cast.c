...
static void find_vertical_boundary(SDL_FPoint point, float angle,
                                   SDL_FPoint *result,
...
void find_horizontal_boundary(SDL_FPoint point, float angle, SDL_FPoint *result,
                              FVec2 *boundary_distance) {
...
static void full_side_cast(Map *map, const SDL_FPoint start_point,
...
void cast_side(Map *map, SDL_FPoint source_point, int is_vertical, float angle,
    ...
    if (is_vertical) {
        ...
        find_horizontal_boundary(source_point, angle, &start_point,
                                 &advancement);
